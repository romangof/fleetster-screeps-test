module.exports.CONSTANTS = {
  ...
  // WORLD_WIDTH and WORLD_HEIGHT constants are deprecated, please use
  // Game.map.getWorldSize() instead
  WORLD_WIDTH: 202,
  WORLD_HEIGHT: 202,
  ...
  PORTAL_UNSTABLE: 10 *1000,
  PORTAL_MIN_TIMEOUT: 12 *1000,
  PORTAL_MAX_TIMEOUT: 22 *1000,
  ...
  SIGN_NOVICE_AREA: 'A new Novice Area is being planned somewhere in this sector. Please make sure al' +
      'l important rooms are reserved.',
  SIGN_RESPAWN_AREA: 'A new Respawn Area is being planned somewhere in this sector. Please make sure a' +
      'll important rooms are reserved.'
};
...
const COLORS_ALL = module.exports = [
  COLOR_RED,
  COLOR_PURPLE,
  COLOR_BLUE,
  COLOR_CYAN,
